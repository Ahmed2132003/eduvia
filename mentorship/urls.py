...
urlpatterns = [
    ...
    path('group/<int:group_id>/<str:group_title>/', views.group_detail, name='group_detail'),
    path('create-group/', views.create_group, name='create_group'),
    path('request-join/<int:group_id>/<str:group_title>/', views.request_join_group, name='request_join_group'),
    path('manage-requests/<int:group_id>/<str:group_title>/', views.manage_group_requests, name='manage_group_requests'),
    ...
    path('group/<int:group_id>/<str:group_title>/edit/', views.edit_group, name='edit_group'),
